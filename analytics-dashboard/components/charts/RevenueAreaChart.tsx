...
export function RevenueAreaChart({ data }: { data: DailySalesSummary[] }) {
      ...
      <AreaChart data={formatted} margin={{ top: 4, right: 4, left: 0, bottom: 4 }}>
        <defs>
          <linearGradient id="revGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="5%"  stopColor="#E8547A" stopOpacity={0.35} />
            <stop offset="95%" stopColor="#9B6DFF" stopOpacity={0.03} />
          </linearGradient>
        </defs>
        ...
        <Area type="monotone" dataKey="total_revenue" stroke="var(--accent)" strokeWidth={2.5}
          fill="url(#revGrad)" dot={false}
          activeDot={{ r: 5, fill: '#E8547A', strokeWidth: 0 }} />
      </AreaChart>
    </ResponsiveContainer>
  )
}
